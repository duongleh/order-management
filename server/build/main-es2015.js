...
const routes = [
    ...
    {
        path: "list-order",
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./app-shell/list-order/list-order.module */ "./src/app/app-shell/list-order/list-order.module.ts")).then(mod => mod.ListOrderModule)
    },
    {
        path: "order-detail",
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./app-shell/order-detail/order-detail.module */ "./src/app/app-shell/order-detail/order-detail.module.ts")).then(mod => mod.OrderDetailModule)
    }
];
...
let ListOrderRoutingModule = class ListOrderRoutingModule {
};
...
let ListOrderComponent = class ListOrderComponent {
    ...
    renderList() {
        this.listOrderService.getListOrder(this.params).subscribe(response => {
...
let ListOrderModule = class ListOrderModule {
};
...
let ListOrderService = class ListOrderService {
    constructor(http) {
        this.http = http;
...
ListOrderService.ctorParameters = () => [
...
let OrderDetailRoutingModule = class OrderDetailRoutingModule {
};
...
let OrderDetailComponent = class OrderDetailComponent {
    constructor(orderDetailService, activatedRoute) {
    ...
    ngOnInit() {
        ...
        this.orderDetailService.getOrderDetail(this.id).subscribe(response => {
            this.order = response;
        }, error => {
            this.WarningMessageOpen = true;
            this.WarningMessageText = `Request to get list items failed: ${error}`;
...
let WarningMessageComponent = class WarningMessageComponent {
    constructor() {
        this.open = false;
        this.text = "";
...
let WarningMessageModule = class WarningMessageModule {
};
